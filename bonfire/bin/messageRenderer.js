...
(function() {
  define(["plugins", "arbiter"], function(pluginsList, arbiter) {
    ...
    renderPlugin = function(context, plugin) {
      ...
      if (plugin.render.length === 4) {
        ...
        renderInnerAndAfter = function(context) {
          return [].concat(renderInner(context)).concat(renderAfter(context));
        };
        vEl = plugin.render(context, renderBefore, renderInnerAndAfter);
      } else {
        renderAll = function(context) {
          return [].concat(renderBefore(context)).concat(renderInner(context)).concat(renderAfter(context));
        };
